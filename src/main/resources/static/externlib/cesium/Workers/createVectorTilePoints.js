...
define(['./AttributeCompression-9ad7a83d', './Cartesian2-e7502022', './Math-34872ab7', './createTaskProcessorWorker', './Check-24483042', './when-54335d57'], function (AttributeCompression, Cartesian2, _Math, createTaskProcessorWorker, Check, when) {
    'use strict';

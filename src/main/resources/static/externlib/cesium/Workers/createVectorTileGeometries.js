...
define(['./Transforms-1ede5d55', './BoxGeometry-8bcc317c', './Cartesian2-e7502022', './Color-088e7e31', './CylinderGeometry-5c50c5ca', './when-54335d57', './EllipsoidGeometry-9b7a9feb', './IndexDatatype-a6fe1d66', './createTaskProcessorWorker', './Check-24483042', './Math-34872ab7', './RuntimeError-88a32665', './GeometryOffsetAttribute-626d552a', './ComponentDatatype-cac6b6fa', './WebGLConstants-95ceb4e9', './GeometryAttribute-66bc2a8a', './GeometryAttributes-caa08d6c', './VertexFormat-525c7b79', './CylinderGeometryLibrary-50a66748'], function (Transforms, BoxGeometry, Cartesian2, Color, CylinderGeometry, when, EllipsoidGeometry, IndexDatatype, createTaskProcessorWorker, Check, _Math, RuntimeError, GeometryOffsetAttribute, ComponentDatatype, WebGLConstants, GeometryAttribute, GeometryAttributes, VertexFormat, CylinderGeometryLibrary) {
    'use strict';

...
define(['./Cartesian2-e7502022', './AttributeCompression-9ad7a83d', './Math-34872ab7', './IndexDatatype-a6fe1d66', './createTaskProcessorWorker', './Check-24483042', './when-54335d57', './WebGLConstants-95ceb4e9'], function (Cartesian2, AttributeCompression, _Math, IndexDatatype, createTaskProcessorWorker, Check, when, WebGLConstants) {
    'use strict';
